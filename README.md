...
The **easyland** package provides the `easyland` CLI command, which load your custom Python file configuration with the -c parameter:
...
The configuration is made in a .py file which allows you to implement any possible workflow. 
